...
// 2017-09-22 21:57:58.434982359 +0200 CEST m=+0.845742352
...
func init(){
	...
	"get_weburl_16411":{
		EmptyFun:		func () db.PgxGener{
		    return new(gener.Get_weburl_16411)
		},
		EmptyInsFun:  func () db.PgxGenerIns{
		    return new(gener.Get_weburl_16411)
		},
				ParamFun: func () db.PgxGenerIns{
		 rt := new(gener.Get_weburl_16411Params)
			
		    return rt
		},
	 Iterator:	func () db.Iterator {
				return new(gener.IterGet_weburl_16411 )
		},
		Flag:		3, },
