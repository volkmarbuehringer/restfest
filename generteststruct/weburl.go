...
// 2017-04-23 14:45:54.005925725 +0200 CEST
...
func (t Weburl) Columns() []string {
	return []string{	 "url" ,	 "zusatz" ,	 "created" ,	 "w_cr_date" ,	 "w_cr_uid" ,	 "addtime" ,	 "addtime1" ,	 "flag" ,	 "test" ,
			}
}

func (x *Weburl) ScannerV() db.InterPgx {
	return db.InterPgx{
				x.Id,
				x.Url,
				x.Zusatz,
...
func (x *Weburl) ScannerVI() db.InterPgx {
	return db.InterPgx{
				x.Url,
				x.Zusatz,
				x.Created,
