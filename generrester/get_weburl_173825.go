...
// 2017-04-20 21:11:00.922427285 +0200 CEST
...
func ScannerGet_weburl_173825I(struT *Get_weburl_173825)  db.InterPgx  {
...
func EmptyGet_weburl_173825() interface{}{
    return new(Get_weburl_173825)
}


func EmptyParamGet_weburl_173825() interface{}{

 rt := new(Get_weburl_173825Params)
...
func ScannerGet_weburl_173825()(  db.InterPgx , interface{}){
	struT := new(Get_weburl_173825)

return  ScannerGet_weburl_173825I(struT), struT

}


func ROWInsertGet_weburl_173825(inter interface{}) db.InterPgx {
...
func ROWQueryGet_weburl_173825(inter interface{}) db.InterPgx {
  rt := inter.( *Get_weburl_173825Params )
