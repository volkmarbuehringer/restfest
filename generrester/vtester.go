...
// 2017-04-26 19:47:45.780651124 +0200 CEST
...
func (t *BaseCopyVtester) Values() ([]interface{}, error) {
	return t.Inter, t.Errc
}


func (t *BaseCopyVtester) ValuesString() (record []string,err error) {
record, err = t.Inter.ConvertItoS()
return
}


func (t BaseCopyVtester) Err() error {
	if t.Errc != io.EOF {
		return t.Errc
	}
	return nil
...
func (t *BaseCopyVtester) NewCopy(rows  *pgx.Rows)  {

	t.Inter = t.Vtester.Scanner()
t.Rows = rows
return
}


func (t *BaseCopyVtester) StartCopy(tab string, con *pgx.Conn, tt pgx.CopyFromSource,rows  *pgx.Rows) error {
...
func (t *BaseCopyVtester) Next() bool {
	var ok bool
	for {
		ok = t.Rows.Next()
		if !ok {
