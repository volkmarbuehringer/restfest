...
// 2017-04-26 19:47:45.824791715 +0200 CEST
...
func (t *BaseCopyWeburl) Values() ([]interface{}, error) {
	return t.Inter, t.Errc
}


func (t *BaseCopyWeburl) ValuesString() (record []string,err error) {
record, err = t.Inter.ConvertItoS()
return
}


func (t BaseCopyWeburl) Err() error {
	if t.Errc != io.EOF {
		return t.Errc
	}
	return nil
...
func (t *BaseCopyWeburl) NewCopy(rows  *pgx.Rows)  {

	t.Inter = t.Weburl.Scanner()
t.Rows = rows
return
}


func (t *BaseCopyWeburl) StartCopy(tab string, con *pgx.Conn, tt pgx.CopyFromSource,rows  *pgx.Rows) error {
...
func (t *BaseCopyWeburl) Next() bool {
	var ok bool
	for {
		ok = t.Rows.Next()
		if !ok {
