...
// 2017-04-26 19:47:45.531501171 +0200 CEST
//code for table lala
...
func (t *BaseCopyLala) Values() ([]interface{}, error) {
	return t.Inter, t.Errc
}


func (t *BaseCopyLala) ValuesString() (record []string,err error) {
record, err = t.Inter.ConvertItoS()
return
}


func (t BaseCopyLala) Err() error {
	if t.Errc != io.EOF {
		return t.Errc
	}
	return nil
...
func (t *BaseCopyLala) NewCopy(rows  *pgx.Rows)  {

	t.Inter = t.Lala.Scanner()
t.Rows = rows
return
}


func (t *BaseCopyLala) StartCopy(tab string, con *pgx.Conn, tt pgx.CopyFromSource,rows  *pgx.Rows) error {
